...
object ReadFiles {
  def inText(day: Int) = s"/Users/bradley.king/dev/aoc2023/src/main/scala/day$day/in.txt"
  def exText(day: Int) = s"/Users/bradley.king/dev/aoc2023/src/main/scala/day$day/ex.txt"
